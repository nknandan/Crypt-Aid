...
export default function NavBar() {
  ...
  useOutsideClick({
    ref: ref,
    handler: () => { setUserMenu(0); setSearchMenu(0);console.log(searchMenu);},
  });
  ...
  return (
    <Box>
            ...
            >
              <InputGroup w={"100%"} border={"0px"}>
                <Input
                  ...
                  onChange={(e) => { setSearchQuery(e.target.value.toLowerCase()); setSearchMenu(1); }}
                />
              </InputGroup>
      ...
      {searchMenu ? (<Flex
        ...
        ref={ref}
      >
        {<SearchTable searchData={search(campaignList)} ref={ref} />}
      </Flex>) : (<></>)}

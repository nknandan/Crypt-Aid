    ...
    <Box bg={useColorModeValue("gray.50", "gray.900")} color={useColorModeValue("gray.700", "gray.200")}>
      <Container as={Stack} maxW={"6xl"} py={4} spacing={4} justify={"center"} align={"center"}>
        ...
        <Stack direction={"row"} spacing={6}>
          ...
          <Link href={"https://github.com/harsh242/betterfund-crowdfunding-in-blockchain"} isExternal>
            Github
          </Link>
      ...
      <Box borderTopWidth={1} borderStyle={"solid"} borderColor={useColorModeValue("gray.200", "gray.700")}>
        ...
        >
          ...
          <Stack direction={"row"} spacing={6}>
            ...
            <SocialButton label={"Twitter"} href={"https://twitter.com/harshbadhai28"}>
              <FaTwitter />
            </SocialButton>
            <SocialButton label={"Github"} href={"https://github.com/harsh242"}>
              <FaGithub />
            </SocialButton>
            <SocialButton label={"Instagram"} href={"https://www.instagram.com/frames_by._harsh/"}>
              <FaInstagram />
            </SocialButton>
          </Stack>
        </Container>

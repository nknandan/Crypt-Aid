...
function UserCard({ name, description, creatorId, imageURL, id, balance, target, ethPrice, dbCamp }) {
    ...
    return (
        <div>
            <NextLink href={`adminProfile/verifyAccount.js`}>
                                        ...
                                        <Flex flexDirection={"row"} width={"100%"} justifyContent={"space-evenly"} flexWrap="wrap">
                                            ...
                                            <NextLink href="/">
                                                ...
                                                >
                                                    ...
                                                    <Flex flexDir={"column"}>
                                                        <Text fontSize={20} fontWeight={"600"}>Permanent Address Proof</Text>
                                                    </Flex>
                                                </Center>
                                            </NextLink>
                                            <NextLink href="/">
                                                ...
                                                >
                                                    ...
                                                    <Flex flexDir={"column"}>
                                                        <Text fontSize={20} fontWeight={"600"}>Signature</Text>
                                                    </Flex>
                                                </Center>
                                            </NextLink>
                                            <NextLink href="/">
                                                ...
                                                >
                                                    ...
                                                    <Flex flexDir={"column"}>
                                                        <Text fontSize={20} fontWeight={"600"}>Photograph</Text>
                                                    </Flex>
                                                </Center>
                                            </NextLink>
                                            <NextLink href="/">

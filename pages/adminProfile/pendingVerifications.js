          ...
          {adminLogIn ? (
            ...
            >
              ...
              >
                <Container
                  mt={"120px"}
                  bgGradient="linear(to-l, gray.300, gray.200)"
                  borderRadius={"30"}
                  py={"20px"}
                  px={"40px"}
                  pos={"relative"}
                >
                  <Text color={"blue.500"} fontSize={"2rem"} fontWeight={"600"} pb={"10px"}>
                    Approve Campaigns
                  </Text>
                  <Flex alignItems={"center"} mt={"10px"}>
                    <SpinnerIcon color={"blue.400"} />
                    <Text color={"black"} fontSize={"1.2rem"} mx={"10px"}>
                      Pending Verifications : <b>9</b>
                    </Text>
                  </Flex>
                  ...
                  <Flex alignItems={"center"} mt={"10px"}>
                    ...
                    <Text color={"black"} fontSize={"1.2rem"} mx={"10px"}>
                      Accounts Verified : <b>19</b>
                    </Text>
                  </Flex>
                  <Flex w={"100%"} justifyContent={"center"}>
                    <NextLink href="./adminProfile/pendingVerifications">
                      <Button
